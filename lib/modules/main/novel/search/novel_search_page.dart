...
class NovelSearchPage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _NovelSearchPageState();
}

class _NovelSearchPageState extends State<NovelSearchPage> {
  late NovelSearchController searchController;
  ...
  void initState() {
    ...
    searchController = NovelSearchController();
        ...
        children: [
          ...
          Column(
            children: [
              ...
              Expanded(
                child: GetBuilder<NovelSearchController>(
