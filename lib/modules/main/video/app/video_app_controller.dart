...
class VideoAppController extends GetxController {
  static VideoAppController get to => Get.find();
  ...
  final Map<String, List<ClassifyContentModel>> dataMap = <String, List<ClassifyContentModel>>{};
  final Map<String, List<TabModel>> childrenDataMap = <String, List<TabModel>>{};
  ...
  void onInit() {
    super.onInit();
    if (null != Get.arguments && Get.arguments is AdsModel) {
      adsModel = Get.arguments as AdsModel;
    }
  }
