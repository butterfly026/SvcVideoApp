...
class UnlockMenuDialog extends StatelessWidget {
  const UnlockMenuDialog({
    super.key,
    required this.data,
    this.onMenuUnlock,
  });
  ...
  static Future<void> show(
    ...
    SmartDialog.show(
      tag: 'unlock_menu',
      builder: (_) {
        return UnlockMenuDialog(data: data, onMenuUnlock: onMenuUnlock);
      },
  ...
  static Future<void> dismiss() async {
    SmartDialog.dismiss(tag: 'unlock_menu');
  }
